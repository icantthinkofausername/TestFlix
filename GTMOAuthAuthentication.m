...
static NSString *const kOAuthApplicaitonNameKey   = @"application_name";
...
/*  NSArray *keys = [NSArray arrayWithObjects:
                   ...
                   nil];
*/
    // Netflix requires the keys below for this request
    NSArray *keys = [NSArray arrayWithObjects:
                     kOAuthTokenKey,
                     kOAuthApplicaitonNameKey,  // added constant
                     kOAuthCallbackKey,
                     kOAuthConsumerKey,
                     nil];
  return keys;
